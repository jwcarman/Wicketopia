...
public class TestFileCfg extends AbstractWicketTestCase {
    ...
    private final Context createContext = new Context(Context.CREATE);
    private final Context updateContext = new Context(Context.UPDATE);
    private final Context listContext = new Context(Context.LIST);
    ...
    public void testVisibility() {
        ...
        PropertyMetaData field3Metadata = wicketopiaPlugin.getBeanMetaData(Entity.class).getPropertyMetaData("field3");
        WicketopiaPropertyFacet facetField3 = WicketopiaPropertyFacet.get(field3Metadata);
    ...
    public void testAbility() {
        ...
        PropertyMetaData disabledMetadata = wicketopiaPlugin.getBeanMetaData(Entity.class).getPropertyMetaData("disabledField");
        WicketopiaPropertyFacet facetDisabled = WicketopiaPropertyFacet.get(disabledMetadata);
    ...
    public void testOrder() {
        ...
        PropertyMetaData field2Metadata = wicketopiaPlugin.getBeanMetaData(Entity.class).getPropertyMetaData("field2");
        WicketopiaPropertyFacet facetField2 = WicketopiaPropertyFacet.get(field2Metadata);
